<template>
  <div class="multistep-form__step multistep-form__step--one">
    ...
    <form @submit.prevent="nextStep" class="multistep-form__form">
      <div class="multistep-form__form-item">
        <input
          type="text"
          v-model.trim="formDataObj.lastname"
          placeholder="Фамилия*"
          :class="{
            invalid:
              $v.formDataObj.lastname.$dirty &&
              !$v.formDataObj.lastname.required,
          }"
        />
        <div
          class="multistep-form__form-error"
          v-if="
            $v.formDataObj.lastname.$dirty && !$v.formDataObj.lastname.required
          "
        >
      ...
      <div class="multistep-form__form-item">
        <input
          type="text"
          v-model.trim="formDataObj.name"
          placeholder="Имя*"
          :class="{
            invalid:
              $v.formDataObj.name.$dirty && !$v.formDataObj.name.required,
          }"
        />
        <div
          class="multistep-form__form-error"
          v-if="$v.formDataObj.name.$dirty && !$v.formDataObj.name.required"
        >
          Поле обязательно к заполнению
        </div>
      </div>
      <div class="multistep-form__form-item">
        <input
          type="text"
          v-model.trim="formDataObj.surname"
          placeholder="Отчество*"
          :class="{
            invalid:
              $v.formDataObj.surname.$dirty && !$v.formDataObj.surname.required,
          }"
        />
        <div
          class="multistep-form__form-error"
      ...
      <div class="multistep-form__form-item">
        <input
          ...
          v-model.trim="formDataObj.date"
          placeholder="Дата рождения*"
          :class="{
            invalid:
              $v.formDataObj.date.$dirty && !$v.formDataObj.date.required,
          }"
        />
        <div
          class="multistep-form__form-error"
          v-if="$v.formDataObj.date.$dirty && !$v.formDataObj.date.required"
        >
          Поле обязательно к заполнению
        </div>
      </div>
      <div class="multistep-form__form-item">
        <input
          type="text"
          v-model.trim="formDataObj.country"
          placeholder="Страна места рождения*"
          :class="{
            invalid:
              $v.formDataObj.country.$dirty && !$v.formDataObj.country.required,
          }"
        />
        <div
          class="multistep-form__form-error"
      ...
      <button type="button" class="multistep-form__gosusl">
        <span class="multistep-form__gosusl-text">Заполнить через</span>
        <span class="multistep-form__gosusl-icon"
          ><svg
  ...
  methods: {
    nextStep() {
      if (this.$v.$invalid) {
        ...
        this.$emit('next-step', 2, this.formDataObj)
      }
    },
  },
}
